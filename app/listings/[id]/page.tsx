  ...
  return (
    <main className="min-h-screen bg-[#FAF8F2] px-6 py-10">
      <div className="mx-auto max-w-6xl">
        <Link href="/listings" className="mb-6 inline-block font-semibold text-green-700">
          ← Back to Listings
        </Link>
...
<div className="mb-10 flex gap-4">
  <a
    ...
    target="_blank"
    className="rounded-xl bg-green-600 px-6 py-4 text-white font-semibold hover:bg-green-700"
  >
    WhatsApp Seller
  </a>
